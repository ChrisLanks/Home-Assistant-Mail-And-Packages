    ...
    if email_list is not None:
        ...
        for fwd in email_list:
            if fwd and fwd != '""' and fwd not in result:
                ...
                if any(amazon_domain in fwd.lower() for amazon_domain in AMAZON_DOMAINS):
                    result.append(fwd)
...
def get_items(
    ...
    amazon_subjects = AMAZON_DELIVERED_SUBJECT + AMAZON_SHIPMENT_SUBJECT + AMAZON_ORDERED_SUBJECT
    all_emails = []
